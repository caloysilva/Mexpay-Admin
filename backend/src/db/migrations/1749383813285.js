module.exports = {
  ...
  async down(queryInterface, Sequelize) {
    ...
    try {
      ...
      await queryInterface.removeColumn('transactions', 'billerId', {
        transaction,
      });
      ...
      await queryInterface.removeColumn('billers', 'service_type', {
        transaction,
      });

      await queryInterface.removeColumn('billers', 'name', { transaction });
      ...
      await queryInterface.dropTable('billers', { transaction });
