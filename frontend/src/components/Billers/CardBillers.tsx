...
const CardBillers = ({
  ...
  const hasUpdatePermission = hasPermission(currentUser, 'UPDATE_BILLERS');
        ...
        {!loading &&
          billers.map((item, index) => (
            ...
            >
              ...
              >
                <Link
                  href={`/billers/billers-view/?id=${item.id}`}
                ...
                <div className='ml-auto '>
                  <ListActionsPopover
                    onDelete={onDelete}
                    itemId={item.id}
                    pathEdit={`/billers/billers-edit/?id=${item.id}`}
                    pathView={`/billers/billers-view/?id=${item.id}`}
