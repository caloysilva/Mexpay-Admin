...
import { create } from '../../stores/billers/billersSlice';
...
BillersNew.getLayout = function getLayout(page: ReactElement) {
  return (
    <LayoutAuthenticated permission={'CREATE_BILLERS'}>
      {page}
    </LayoutAuthenticated>
  );
};

export default BillersNew;
