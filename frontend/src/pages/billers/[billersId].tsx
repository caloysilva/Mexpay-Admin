...
const EditBillers = () => {
  ...
  const { billersId } = router.query;

  useEffect(() => {
    dispatch(fetch({ id: billersId }));
  }, [billersId]);
  ...
  const handleSubmit = async (data) => {
    await dispatch(update({ id: billersId, data }));
...
EditBillers.getLayout = function getLayout(page: ReactElement) {
  return (
